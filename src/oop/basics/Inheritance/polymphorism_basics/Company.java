package oop.basics.Inheritance.polymphorism_basics;
...
public class Company {
    public static void main(String[] args) {
        ...
        CEO ceo = new CEO("Zdzichu","Boss",40000,"R&D",100);

        Employee person = ceo;
        person.printInfo(); //Ceo: zdzichu z klasy Ceo
        ceo.signContract();
        person.doWork();
        ceo.printInfo();//Ceo: zdzichu z klasy Ceo
        Manager worker = ceo;
        worker.printInfo();
        worker.hireEmployee();//Ceo: zdzichu z klasy Ceo
    }
}
